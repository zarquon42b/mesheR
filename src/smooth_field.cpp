...
rowvec smooth_field_at_point_with_distance(const mat &displacement, const rowvec &distance, ScalarValuedKernel<rowvec>* scalarkernel, double gamma, const std::vector<float>  &use) {
